...
export const routes: RoutesWithMeta = [
    ...
    },
    {
        ...
        title: 'FreeCell',
        icon: 'style',
        loadComponent: () => import('./experiments/free-cell/free-cell.component').then(r => r.FreeCellComponent),
    },
    {
        path: 'clip-path-test',
        category: 'Experiments',
    ...
    {
        path: 'cogent-load-march-madness',
        category: 'Load Screens',
        title: 'March Madness',
        subcategory: 'Game',
        icon: 'sports_basketball',
        loadComponent: () => import('./load-screens/cogent-load-march-madness/cogent-load-march-madness.component').then(r => r.CogentLoadMarchMadnessComponent),
    },
    {
    ...
    {
        path: 'cogent-arbor-day',
        category: 'Load Screens',
        title: 'Arbor Day',
        subcategory: 'Spring',
        icon: 'local_florist',
        loadComponent: () => import('./load-screens/cogent-arbor-day/cogent-arbor-day.component').then(r => r.CogentArborDayComponent),
    },
    {
        path: 'polariod-carousel-2',
        title: 'Polaroid Carousel 2',
        category: 'Widgets',
        icon: 'photo_library',
